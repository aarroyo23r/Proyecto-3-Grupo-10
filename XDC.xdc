...
set_property PACKAGE_PIN U9 [get_ports MasterReset]
set_property IOSTANDARD LVCMOS33 [get_ports MasterReset]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
##set_property PACKAGE_PIN U8 [get_ports Escribir]
##set_property IOSTANDARD LVCMOS33 [get_ports Escribir]
...
##set_property PACKAGE_PIN V7 [get_ports {push_centro}]
...
##set_property PACKAGE_PIN T16 [get_ports push_izquierda]
##set_property IOSTANDARD LVCMOS33 [get_ports push_izquierda]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
##set_property PACKAGE_PIN R10 [get_ports push_derecha]
##set_property IOSTANDARD LVCMOS33 [get_ports push_derecha]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
##set_property PACKAGE_PIN V10 [get_ports push_abajo]
##set_property IOSTANDARD LVCMOS33 [get_ports push_abajo]



##Pmod Header JA
##Bank = 15, Pin name = IO_L1N_T0_AD0N_15,					Sch name = JA1
##set_property PACKAGE_PIN B13 [get_ports {DATA_ADDRESS[0]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[0]}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
##set_property PACKAGE_PIN F14 [get_ports {DATA_ADDRESS[1]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[1]}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
##set_property PACKAGE_PIN D17 [get_ports {DATA_ADDRESS[2]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[2]}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
##set_property PACKAGE_PIN E17 [get_ports {DATA_ADDRESS[3]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[3]}]
##Bank = 15, Pin name = IO_0_15,								Sch name = JA7
##set_property PACKAGE_PIN G13 [get_ports {DATA_ADDRESS[4]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[4]}]
##Bank = 15, Pin name = IO_L20N_T3_A19_15,					Sch name = JA8
##set_property PACKAGE_PIN C17 [get_ports {DATA_ADDRESS[5]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[5]}]
##Bank = 15, Pin name = IO_L21N_T3_A17_15,					Sch name = JA9
##set_property PACKAGE_PIN D18 [get_ports {DATA_ADDRESS[6]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[6]}]
##Bank = 15, Pin name = IO_L21P_T3_DQS_15,					Sch name = JA10
##set_property PACKAGE_PIN E18 [get_ports {DATA_ADDRESS[7]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[7]}]



##Pmod Header JB
##Bank = 15, Pin name = IO_L15N_T2_DQS_ADV_B_15,				Sch name = JB1
##set_property PACKAGE_PIN G14 [get_ports ChipSelect]
...
set_property PACKAGE_PIN H4 [get_ports {DATA_ADDRESS[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[0]}]
##Bank = 35, Pin name = IO_L17P_T2_35,						Sch name = JD2
set_property PACKAGE_PIN H1 [get_ports {DATA_ADDRESS[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[1]}]
##Bank = 35, Pin name = IO_L17N_T2_35,						Sch name = JD3
set_property PACKAGE_PIN G1 [get_ports {DATA_ADDRESS[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADRRESS[2]}]
##Bank = 35, Pin name = IO_L20N_T3_35,						Sch name = JD4
set_property PACKAGE_PIN G3 [get_ports {DATA_ADDRESS[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADRESS[3]}]
##Bank = 35, Pin name = IO_L15P_T2_DQS_35,					Sch name = JD7
set_property PACKAGE_PIN H2 [get_ports {DATA_ADDRESS[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[4]}]
##Bank = 35, Pin name = IO_L20P_T3_35,						Sch name = JD8
set_property PACKAGE_PIN G4 [get_ports {DATA_ADDRESS[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[5]}]
##Bank = 35, Pin name = IO_L15N_T2_DQS_35,					Sch name = JD9
set_property PACKAGE_PIN G2 [get_ports {DATA_ADRESS[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[6]}]
##Bank = 35, Pin name = IO_L13N_T2_MRCC_35,					Sch name = JD10
set_property PACKAGE_PIN F3 [get_ports {DATA_ADRRESS[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DATA_ADDRESS[7]}]
...
set_property PACKAGE_PIN A3 [get_ports {rgbO[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgbO[8]}]
##Bank = 35, Pin name = IO_L7N_T1_AD6N_35,					Sch name = VGA_R1
set_property PACKAGE_PIN B4 [get_ports {rgbO[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgbO[9]}]
##Bank = 35, Pin name = IO_L1N_T0_AD4N_35,					Sch name = VGA_R2
set_property PACKAGE_PIN C5 [get_ports {rgbO[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgbO[10]}]
##Bank = 35, Pin name = IO_L8P_T1_AD14P_35,					Sch name = VGA_R3
set_property PACKAGE_PIN A4 [get_ports {rgbO[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgbO[11]}]
##Bank = 35, Pin name = IO_L2P_T0_AD12P_35,					Sch name = VGA_B0
set_property PACKAGE_PIN B7 [get_ports {rgbO[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgbO[0]}]
##Bank = 35, Pin name = IO_L4N_T0_35,						Sch name = VGA_B1
set_property PACKAGE_PIN C7 [get_ports {rgbO[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgbO[1]}]
##Bank = 35, Pin name = IO_L6N_T0_VREF_35,					Sch name = VGA_B2
set_property PACKAGE_PIN D7 [get_ports {rgbO[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgbO[2]}]
##Bank = 35, Pin name = IO_L4P_T0_35,						Sch name = VGA_B3
set_property PACKAGE_PIN D8 [get_ports {rgbO[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgbO[3]}]
##Bank = 35, Pin name = IO_L1P_T0_AD4P_35,					Sch name = VGA_G0
set_property PACKAGE_PIN C6 [get_ports {rgbO[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgbO[4]}]
##Bank = 35, Pin name = IO_L3N_T0_DQS_AD5N_35,				Sch name = VGA_G1
set_property PACKAGE_PIN A5 [get_ports {rgbO[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgbO[5]}]
##Bank = 35, Pin name = IO_L2N_T0_AD12N_35,					Sch name = VGA_G2
set_property PACKAGE_PIN B6 [get_ports {rgbO[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgbO[6]}]
##Bank = 35, Pin name = IO_L3P_T0_DQS_AD5P_35,				Sch name = VGA_G3
set_property PACKAGE_PIN A6 [get_ports {rgbO[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgbO[7]}]
